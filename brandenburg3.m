...
addpath("C:\Program Files\MATLAB\R2024a\toolbox\miditoolbox")
midiFile = readmidi("C:\Users\errat\Downloads\bach_brandenburg_3.mid");
...
minDesired = 125; %%Maybe half of the light intensity can serve as a good minimum)
maxDesired = 255;

% Scale the values so that the minimum value becomes 127 and the maximum value becomes 255
